...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(5.0f, -6.0f, -4.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(20.0f, 8.0f, 12.0f));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));//rotacion en la base
		model = glm::translate(model, glm::vec3(0.0f, 10.0f, 2.5f));//traslacion para eje de rotación
		modelaux = model;
		model = glm::scale(model, glm::vec3(5.0f, 20.0f, 5.0f));//primer
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::translate(model, glm::vec3(-7.5f, 8.0f, 0.0f));
		model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(5.0f, 20.0f, 5.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(10.0f, -14.0f, 2.5f));
		...
		model = glm::translate(model, glm::vec3(1.0f, -14.0f, -10.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::translate(model, glm::vec3(10.0f, -14.0f, -10.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::translate(model, glm::vec3(5.0f, -10.0f, -4.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(13.0f, 12.0f, 13.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
